...
import {
  ...
  LogOut, Menu, X, User, Calendar, Trophy, Settings
} from 'lucide-react';
...
function PrincipalLayout() {
  ...
  const navItems = [
    { path: '/principal', label: 'Dashboard', icon: LayoutDashboard },
    { path: '/principal/departments', label: 'Departments', icon: Building2 },
    { path: '/principal/leave-management', label: 'Leave Management', icon: FileText },
    { path: '/principal/club-management', label: 'Club Management', icon: Trophy },
    { path: '/principal/performance', label: 'Performance', icon: TrendingUp },
    { path: '/principal/calendar', label: 'Calendar', icon: Calendar },
    { path: '/principal/settings', label: 'Settings', icon: Settings },
    { path: '/principal/profile', label: 'Profile', icon: User }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-blue-50">
      ...
      <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-72 lg:flex-col">
        <div className="flex flex-col flex-grow bg-gradient-to-b from-purple-700 via-indigo-700 to-blue-700 overflow-y-auto shadow-2xl">
          {/* Logo */}
          <div className="flex items-center justify-center h-20 flex-shrink-0 px-4 bg-white/10 backdrop-blur-sm">
            <h1 className="text-2xl font-bold text-white">Principal Portal</h1>
          </div>
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed left-0 top-0 bottom-0 w-72 bg-gradient-to-b from-purple-700 via-indigo-700 to-blue-700 shadow-2xl z-50 overflow-y-auto"
            >
              {/* Logo */}
